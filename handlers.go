...
func (plat *platformDetails) setPlatformDetails(env string) {
	switch (env) {
	case "k8s-aws":
		plat.provider = "EKS on AWS"
		plat.css = "aws-platform"
	case "ocp-aws":
		plat.provider = "OCP on AWS"
		plat.css = "aws-platform"
	case "k8s-azure":
		plat.provider = "AKS on Azure"
		plat.css = "azure-platform"
	case "ocp-azure":
		plat.provider = "OCP on Azure"
		plat.css = "azure-platform"
	case "k8s-gcp":
		plat.provider = "GKE on Google Cloud"
		plat.css = "gcp-platform"
	case "ocp-gcp":
		plat.provider = "OCP on Google Cloud"
		plat.css = "gcp-platform"
	case "k8s-ibm":
		plat.provider = "IKS on IBM Cloud"
		plat.css = "ibm-platform"
	case "ocp-ibm":
		plat.provider = "ROKS on IBM Cloud"
		plat.css = "ibm-platform"
	case "k8s-on-premise":
		plat.provider = "K8S on premise"
		plat.css = "onprem-platform"
	case "ocp-on-premise":
		plat.provider = "OCP on premise"
		plat.css = "onprem-platform"
	default:
		plat.provider = "K8S"
		plat.css = "onprem-platform"
